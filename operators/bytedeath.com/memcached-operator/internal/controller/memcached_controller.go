...
import (
	...
	cachev1 "bytedeath.com/memcached-operator/api/v1"
)

const memcachedFinalizer = "cache.bytedeath.com/finalizer"
...
//+kubebuilder:rbac:groups=cache.bytedeath.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.bytedeath.com,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.bytedeath.com,resources=memcacheds/finalizers,verbs=update
